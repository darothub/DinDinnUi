...
@ModelView(autoLayout = ModelView.Size.WRAP_WIDTH_WRAP_HEIGHT, defaultLayout = R.layout.cart_item)
class CartListView @JvmOverloads constructor(context: Context, attr:AttributeSet?=null, defStyleAttr:Int=0)
    : ConstraintLayout(context, attr, defStyleAttr) {

    var binding :CartItemBinding = CartItemBinding.inflate(LayoutInflater.from(context),
        this, true)
    @ModelProp
